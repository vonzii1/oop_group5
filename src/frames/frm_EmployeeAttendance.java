...
public class frm_EmployeeAttendance extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error retrieving overtime hours: " + e.getMessage());
            return "";
        }
    }
    ...
    public String getOvertimeStart() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error retrieving overtime start time: " + e.getMessage());
            return "";
        }
    }
    ...
    public String getOvertimeEnd() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error retrieving overtime end time: " + e.getMessage());
            return "";
        }
    }
    ...
    public String getReason() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error retrieving reason for overtime: " + e.getMessage());
            return "";
        }
