 ...
 * @author User
 */
public class frm_AddEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 190, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_AddEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
